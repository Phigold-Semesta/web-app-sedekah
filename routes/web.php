...
// Tambahkan di dalam group route admin Anda
Route::delete('/jemput-donasi/destroy/{id_donasi}', [App\Http\Controllers\AdminController::class, 'destroy_jemput'])->name('jemput_donasi.destroy');
