...
<div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
    ...
    <div class="flex items-center gap-2">
        <span class="text-xs font-bold text-slate-400 uppercase">Tampil:</span>
        <select onchange="window.location.href = this.value" class="bg-slate-50 dark:bg-slate-800 border-0 rounded-lg text-xs font-bold text-slate-700 dark:text-white p-2 cursor-pointer focus:ring-emerald-500">
                ...
                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                    ...
                    <td class="px-8 py-6">
                        @php
                            ...
                            // Map 'belum bayar' dan variasi lainnya menjadi 'pending'
                            $statusMap = [
                            ...
                            $colors = [
                                'pending' => 'bg-orange-100 text-orange-700', // Orange sesuai permintaan
                        ...
                        @endphp
                        <span class="px-4 py-1 rounded-full text-[10px] font-black {{ $colorClass }} uppercase">
                            {{ $status }}
                        </span>
                    </td>
                </tr>
