...
<div class="max-w-4xl mx-auto space-y-8 animate__animated animate__fadeInUp">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <a href="{{ route('admin.manajemen_user.index') }}" 
            ...
            <i class="fas fa-arrow-left group-hover:-translate-x-1 transition-transform text-xs"></i> Kembali
        </a>
    </div>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-[3rem] border border-emerald-50 dark:border-emerald-900/20 shadow-2xl shadow-emerald-900/5 dark:shadow-none overflow-hidden relative">
        ...
        <form action="{{ route('admin.manajemen_user.update', $user->id_user) }}" method="POST" class="p-8 md:p-12 space-y-10 relative z-10" autocomplete="off">
            @csrf
            @method('PUT')
