...
@section('title', 'Authorize User | Provisioning')
...
<div class="max-w-4xl mx-auto space-y-8 animate__animated animate__fadeInUp">
    ...
    {{-- Form Container --}}
    <div class="bg-white dark:bg-slate-900 rounded-[3.5rem] border border-emerald-50 dark:border-emerald-900/20 shadow-2xl overflow-hidden relative">
        ...
        <div class="p-8 md:p-14 relative z-10">
            <form action="{{ route('direktur.manajemen_user.store') }}" method="POST" class="space-y-6">
                @csrf

                {{-- Full Name Input --}}
                <div class="group space-y-2">
                    <label class="text-[10px] font-black text-slate-400 dark:text-emerald-600/50 uppercase tracking-[0.3em] ml-2 group-focus-within:text-emerald-500 transition-colors">Full Operational Name</label>
                    <div class="relative">
                        ...
                        <input type="text" name="nama_user" value="{{ old('nama_user') }}" required 
                            class="w-full pl-14 pr-6 py-5 bg-slate-50 dark:bg-slate-800/50 border-2 border-transparent rounded-3xl text-sm font-bold text-slate-700 dark:text-white custom-focus focus:border-[#008f5d] focus:bg-white dark:focus:bg-slate-900 transition-all uppercase placeholder:normal-case @error('nama_user') border-red-500 @enderror"
                    ...
                    <div class="group space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="username" value="{{ old('username') }}" required 
                                class="w-full pl-14 pr-6 py-5 bg-slate-50 dark:bg-slate-800/50 border-2 border-transparent rounded-3xl text-sm font-bold text-slate-700 dark:text-white custom-focus focus:border-[#008f5d] focus:bg-white dark:focus:bg-slate-900 transition-all @error('username') border-red-500 @enderror"
                    ...
                    <div class="group space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" id="password" required 
                                class="w-full pl-14 pr-14 py-5 bg-slate-50 dark:bg-slate-800/50 border-2 border-transparent rounded-3xl text-sm font-bold text-slate-700 dark:text-white custom-focus focus:border-[#008f5d] focus:bg-white dark:focus:bg-slate-900 transition-all @error('password') border-red-500 @enderror"
                                placeholder="••••••••">
                            <button type="button" onclick="togglePassword('password', 'toggle-icon')" 
                                class="absolute inset-y-0 right-0 pr-6 flex items-center text-slate-300 hover:text-[#008f5d] transition-colors">
                ...
                <div class="group space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <select name="role" required 
                            class="w-full pl-14 pr-10 py-5 bg-slate-50 dark:bg-slate-800/50 border-2 border-transparent rounded-3xl text-sm font-black uppercase italic text-emerald-600 dark:text-emerald-400 focus:outline-none focus:border-[#008f5d] focus:bg-white dark:focus:bg-slate-900 transition-all appearance-none cursor-pointer">
